...
To this end, you may have to tweek the settings in your IDE. In Spyder, for instance, you should set your Graphics backend to "Authomatic", not "Inline".
You can do so this way:<br>
